...
// console.log(new Date('2025-01-03T13:53:27.094Z').getTime())

function verificaSePassou15Minutos(data) {
    const dataAtual = new Date()
    data = new Date(data)
    const diferenca = dataAtual.getTime() - data.getTime()
    return diferenca > 900000
}

function verificaSeODiaEOMesmo(data) {
    const dataAtual = new Date()
    data = new Date(data)
    return dataAtual.getDate() === data.getDate() && dataAtual.getMonth() === data.getMonth()
}

console.log(verificaSePassou15Minutos('2025-01-03T13:53:27.094Z'))

const data = '2025-01-03T13:53:27.094Z'
